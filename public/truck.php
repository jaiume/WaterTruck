...
<head>
    ...
    <style>
        ...
        * { font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .status-badge.setup { background: rgba(0,0,0,0.25); color: #fff; }
        .status-badge.inactive { background: rgba(0,0,0,0.25); color: rgba(255,255,255,0.75); }
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="d-flex flex-column align-items-end gap-1">
                    ...
                    <div id="nav-links" style="display:none; font-size:0.8rem; text-align:right; white-space:nowrap;">
                        ...
                        <a href="/operator" class="text-white text-decoration-none opacity-75" id="operator-link" style="display:none;">Operator Dashboard</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="setup-section" class="setup-form">
            <div class="section-card">
                ...
                <form id="setup-form">
                    ...
                    <button type="button" class="btn btn-outline-secondary w-100 mt-2" onclick="if(truck && isTruckComplete()) { showDashboard(); } else { localStorage.setItem('last_view','customer'); window.location.href='/'; }">
                        Cancel
                    </button>
                </form>
            </div>
                ...
                <div class="job-card active">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="job-time">$${parseFloat(job.price).toFixed(0)}${job.status === 'accepted' ? ` • Waiting ${timeAgo(job.accepted_at)}` : ''}</div>
                        </div>
